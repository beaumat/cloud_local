...
use App\Livewire\PhilhealthPrint\PrintOutBPN;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('/patients')->name('patients')->group(function () {
        ...
        Route::prefix('/phil-health')->group(function () {
            ...
            Route::get('/{id}/printout-ncr', PrintOutBPN::class)->name('printout_ncr')->middleware(['permission:patient.philhealth.print']);
