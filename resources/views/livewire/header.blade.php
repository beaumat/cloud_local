<nav class="main-header navbar navbar-expand navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                class="nav-link dropdown-toggle">Transaction</a>
            <ul aria-labelledby="dropdownSubMenu1" class="border-0 shadow dropdown-menu">
                <li><a href="#" class="dropdown-item">Some action </a></li>
                <li><a href="#" class="dropdown-item">Some other action</a></li>
    ...
    <ul class="ml-auto navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" wire:click="logout" title="exit"  data-slide="true" href="#" role="button" wire:confirm="Are you sure you want to logout?" >
