...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('customerssales_receipt') }}"> Sales Receipt </a></h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center col-1 bg-success">
                                            @can('customer.invoice.create')
                                                <a href="{{ route('customerssales_receipt_create') }}"
                                ...
                                <tbody class="text-xs">
                                    @foreach ($dataList as $list)
                                        <tr>
                                            <td>
                                                <a href="{{ route('customerssales_receipt_edit', ['id' => $list->ID]) }}"
                                                    class="text-primary">
                                                    {{ $list->CODE }}
                                                </a>
                                            </td>
