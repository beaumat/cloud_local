                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"
                                            ...
                                            <livewire:select-option name="TYPE" :options="$itemType" titleName="Type"
                                                :zero="false" wire:model.live='TYPE' :vertical="true">
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        @if ($TYPE === 0)
                                            <div class="col-md-6">
                                                <livewire:text-input name="PURCHASE_DESCRIPTION"
                                                    titleName="Purchase Description" wire:model='PURCHASE_DESCRIPTION'
                                                    :vertical="true">
                                            </div>
                                        @endif
                                    ...
                                    <div class="row">
                                            ...
                                            @if ($TYPE < 2)
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        @if ($TYPE === 0)
                                                            <div class="col-md-12">
                                                                <livewire:number-input name="COST" titleName="Cost"
                                                                    wire:model='COST' :vertical="true">
                                                            </div>
                                                        @endif
                                                        <div class="col-md-12">
                                                            <livewire:select-option name="GROUP_ID" :options="$itemGroup"
                                                                :zero="true" titleName="Item Group"
                                                                wire:model='GROUP_ID' :vertical="true">
                                                        </div>

                                                        <div class="col-md-12">
                                                            <livewire:select-option name="STOCK_TYPE" :options="$stockType"
                                                                :zero="true" titleName="Stock Type"
                                                                wire:model='STOCK_TYPE' :vertical="true">
                                                        </div>
                                                        ...
                                                        @if ($TYPE === 0)
                                                            ...
                                                            <div class="col-md-12">
                                                                <livewire:select-option name="COGS_ACCOUNT_ID"
                                                                    ...
                                                                    wire:model='COGS_ACCOUNT_ID' :vertical="true">
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                        ...
                                        @if ($TYPE <= 4 || $TYPE === 7)
                                            <div class="col-md-6">
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            @if ($itemSubClass)
                                                                <livewire:select-option name="SUB_CLASS_ID"
                                                                    titleName="Item Sub-class" :options="$itemSubClass"
                                                                    :zero="true" wire:model='SUB_CLASS_ID'
                                                                    :key="$itemSubClass->pluck('ID')->join('_')" :vertical="true">
                                                                @else
                                                                    <livewire:select-option name="SUB_CLASS_ID"
                                                                        titleName="Item Sub-class" :options="[]"
                                                                        :zero="true" wire:model='SUB_CLASS_ID'
                                                                        :vertical="true">
                                                            @endif
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        @if ($TYPE < 2)
                                                            <livewire:select-option name="GL_ACCOUNT_ID"
                                                                :options="$accounts" :zero="true"
                                                                titleName="Income Accounts" wire:model='GL_ACCOUNT_ID'
                                                                :vertical="true">
                                                            @else
                                                                <livewire:select-option name="GL_ACCOUNT_ID"
                                                                    :options="$accounts" :zero="true"
                                                                    titleName="GL Accounts" wire:model='GL_ACCOUNT_ID'
                                                                    :vertical="true">
                                                        @endif
                                                    ...
                                                    <div class="col-md-12">
                                                        <livewire:custom-check-box name="TAXABLE" titleName="Taxable"
                                                            wire:model='TAXABLE'>
                                                    </div>
                                        ...
                                        @if ($TYPE === 4 || $TYPE === 7)
                                            <div class="col-md-6">
                                                <livewire:select-option name="RATE_TYPE" :options="$rateType"
                                                    :zero="false" titleName="Rate Type" wire:model='RATE_TYPE'
                                                    :vertical="true">
                                            </div>
                                        @endif
                                        @if ($TYPE <= 4 || $TYPE === 7)
                                                    ...
                                                    @if ($TYPE < 2)
                                                        <div class="col-md-12">
                                                            <livewire:select-option name="ASSET_ACCOUNT_ID"
                                                                ...
                                                                wire:model='ASSET_ACCOUNT_ID' :vertical="true" />
                                                        </div>
                                                    @endif
                                                    <div class="col-md-12">
                                        ...
                                        @if ($TYPE < 2)
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <livewire:select-option name="BASE_UNIT_ID" :options="$units"
                                                            :zero="true" titleName="Base Unit"
                                                            wire:model='BASE_UNIT_ID' :vertical="true">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <livewire:select-option name="PURCHASES_UNIT_ID"
                                                            :options="$units" :zero="true"
                                                            titleName="Purchases Unit" wire:model='PURCHASES_UNIT_ID'
                                                            :vertical="true">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <livewire:select-option name="SHIPPING_UNIT_ID"
                                                            :options="$units" :zero="true"
                                                            titleName="Shipping Unit" wire:model='SHIPPING_UNIT_ID'
                                                            :vertical="true">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <livewire:select-option name="SALES_UNIT_ID" :options="$units"
                                                            :zero="true" titleName="Sales Unit"
                                                            wire:model='SALES_UNIT_ID' :vertical="true">
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
