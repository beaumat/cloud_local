                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"  @if ($ID > 0) style="opacity: 0.5;pointer-events: none;" @endif>
                                            <livewire:select-option name="TYPE" :options="$paymentTermTypes" :zero="false"
                                                titleName="Type" wire:model.live='TYPE' :key="$paymentTermTypes->pluck('ID')->join('_')" />
                                        </div>
                                        <div class="col-md-2">
                                            <livewire:number-input name="NET_DUE" titleName="Net Due"
                                                wire:model='NET_DUE' />
                                        </div>
                                        <div class="col-md-2"  @if ($TYPE > 0) style="opacity: 0.5;pointer-events: none;" @endif>
                                            <livewire:number-input name="DATE_MIN_DAYS" titleName="Day of Due date"
                                                wire:model='DATE_MIN_DAYS' />
                                        </div>
                                        <div class="col-md-2">
                                            <livewire:number-input name="DISCOUNT_PCT" titleName="Discount Percent"
                                                wire:model='DISCOUNT_PCT' />
                                        </div>
                                        <div class="col-md-2">
                                            <livewire:number-input name="DISCOUNT_DUE" titleName="Discount Due"
