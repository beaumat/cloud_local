                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-6">
                                                    @if ($Modify)
                                                        <livewire:select-option name="ACCOUNT_ID1"
                                                            ...
                                                            :isDisabled="false" wire:model='ACCOUNT_ID' />
                                                    @else
                                                        <livewire:select-option name="ACCOUNT_ID2"
                                                            titleName="Bank Account" :options="$accountList" :zero="true"
                                                            :isDisabled="true" wire:model='ACCOUNT_ID' />
                                                    @endif
                                                </div>
                                                ...
                                                <div class="col-md-3 col-3">
                                                    <livewire:number-input name="IE_RATE" titleName="Interest Earn "
                                                        isDisabled="{{ !$Modify }}" wire:model='IE_RATE' />
                                                </div>

                                                <div class="col-md-3 col-3">
                                                    <livewire:date-input name="IE_DATE" titleName="Date"
                                                        wire:model.live='IE_DATE' isDisabled="{{ !$Modify }}" />
                                                </div>
                                                <div class="col-md-6 col-6">
                                                    @if ($Modify)
                                                        <livewire:select-option name="IE_ACCOUNT_ID1"
                                                            titleName="Account" :options="$ie_accountList" :zero="true"
                                                            :isDisabled="false" wire:model='IE_ACCOUNT_ID' />
                                                    @else
                                                        <livewire:select-option name="EI_ACCOUNT_ID2"
                                                            titleName="Account" :options="$ie_accountList" :zero="true"
                                                            :isDisabled="true" wire:model='IE_ACCOUNT_ID' />
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    @if ($ID == 0 && auth()->user()->date_enabled)
                                                        <livewire:date-input name="DATE" titleName="Date Bank Statement"
