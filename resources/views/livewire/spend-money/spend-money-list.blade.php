<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('bankingspend_money') }}"> Spend Money </a></h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                <thead class="text-xs bg-sky">
                                    <tr>
                                        ...
                                        <th class="text-center bg-success col-1">
                                            @can('banking.spend-money.create')
                                                <a href="{{ route('bankingspend_money_create') }}"
                                ...
                                <tbody class="text-xs">
                                    @foreach ($dataList as $list)
                                        <tr>
                                            <td>
                                                <a href="{{ route('bankingspend_money_edit', ['id' => $list->ID]) }}">
                                                    {{ $list->CODE }}
                                                </a>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a title="View"
                                                    href="{{ route('bankingspend_money_edit', ['id' => $list->ID]) }}"
                                                    class="btn btn-xs btn-info">
                                                    <i class="fas fa-eye" aria-hidden="true"></i>
                                                </a>

                                                @if (auth()->user()->can('banking.spend-money.delete'))
