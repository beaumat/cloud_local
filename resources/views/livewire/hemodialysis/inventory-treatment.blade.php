        ...
        <div class="card-body p-2">
            ...
            <div class="row" @if ($HEMO_ID==0) style="opacity: 0.5;pointer-events: none;" @endif>
                        ...
                        <tbody class="text-xs">
                            ...
                            <tr
                                ...
                                <td class="text-center">
                                    @if ($lineId == $list->ID)
                                    <input type="number" step="0.01" class="w-100 text-xs text-right" name="lineQty"
                                        wire:model='lineQty' />
                                    @else
                                ...
                                <td class="text-center">
                                    @if ($lineId == $list->ID)
                                    <button type="button" title="Update" id="updatebtn" wire:click="updateItem()"
                                    ...
                                    <button type="button" title="Edit" id="editbtn"
                                        wire:click='editItem({{ $list->ID }})' class="btn btn-xs btn-primary">
                ...
                <div class="col-md-12">
                    ...
                    <button wire:click='openSubClass({{ $list->ID }})' class="btn btn-success active btn-sm m-1">
