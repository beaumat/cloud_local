                            ...
                            <table class="table table-sm table-bordered table-hover">
                                ...
                                <tbody class="text-xs bg-light">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> @if ($list->IS_SC) <i class="fa fa-check text-success"
                                                aria-hidden="true"></i> @else <i class="fa fa-times text-danger"
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if ($list->FILE_PATH)
                                            <a type="button" href="{{ asset('storage/' . $list->FILE_PATH) }}"
