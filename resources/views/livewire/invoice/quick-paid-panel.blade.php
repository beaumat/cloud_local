                    ...
                    <form id="quickForm" wire:submit.prevent='save'>
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-4">
                                    <div class="row">
                                        <div class="col-4"><label>Invoice No. : </label> </div>
                                        <div class="col-8 text-primary"> {{ $CODE }}</div>
                                        <div class="col-4"><label>Date. : </label></div>
                                        <div class="col-8 text-primary">{{ $DATE }}</div>
                                        <div class="col-4"><label>P.O # : </label></div>
                                        <div class="col-8 text-primary">{{ $PO_NUMBER }}</div>
                                        <div class="col-4"><label>Due Date : </label></div>
                                        <div class="col-8 text-primary">{{ $DUE_DATE }}</div>
                                        ...
                                        <div class="col-8 text-primary">{{ number_format($BALANCE_DUE, 2) }}</div>
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <select class="form-control form-control-sm" wire:model.live='TAX_ID'>
