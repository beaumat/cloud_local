<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('maintenanceinventoryitem_sub_class') }}"> Item Sub Class </a>
                    </h5>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <div class="text-right col-6 col-md-6">
                                        @if ($ID > 0)
                                            <a id="new" title="Create"
                                                href="{{ route('maintenanceinventoryitem_sub_class_create') }}"
