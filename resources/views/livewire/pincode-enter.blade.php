            ...
            <div class="modal-dialog model-sm modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="password" class="form-control form-control-sm" wire:model='PIN' title="Pin password" placeholder="Pin password" />
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-warning btn-md" wire:click='logpin()'>
