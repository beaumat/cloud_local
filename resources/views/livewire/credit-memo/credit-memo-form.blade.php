                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="pt-1 pb-1 card-header bg-sky">
                            <div class="row">
                                <div class="col-sm-6">
                                    <a class="text-white" href="{{ route('customerscredit_memo') }}">
                                        Credit Memo
                                    </a>
                                </div>
                                    ...
                                    <div class="text-right col-6 col-md-6">
                                        @if ($ID > 0 && $STATUS > 0)
                                            <a id="new" title="Create"
                                                href="{{ route('customerscredit_memo_create') }}"
                                    ...
                                    <div class="tab-pane fade @if ($tab == 'item') show active @endif"
                                        ...
                                        <div class="row"
                                            ...
                                            <div class="col-md-12"
                                                ...
                                                @livewire('CreditMemo.CreditMemoFormItems', ['CREDIT_MEMO_ID' => $ID, 'STATUS' => $STATUS, 'TAX_ID' => $OUTPUT_TAX_ID])
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-4 text-left">
                                        @livewire('CreditMemo.InvoiceListPromp', ['CREDIT_MEMO_ID' => $ID, 'CUSTOMER_ID' => $CUSTOMER_ID, 'LOCATION_ID' => $LOCATION_ID, 'AMOUNT' => $AMOUNT, 'AMOUNT_APPLIED' => $AMOUNT_APPLIED])
                                    </div>
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 text-right">
                                                <label class="text-sm">Amount Applied:</label>
                                                <label
                                                    class="text-primary text-lg">{{ number_format($AMOUNT_APPLIED, 2) }}</label>
                                            </div>
                                            <div class="col-md-3 text-right">
                                                <label class="text-sm">Unapplied Amount:</label>
                                                <label
                                                    class="text-success text-lg">{{ number_format($AMOUNT - $AMOUNT_APPLIED, 2) }}</label>
