<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('bankingbank_transfer') }}"> Bank Transfer </a></h5>
                </div>
                <div class="col-sm-6">
                            ...
                            <table class="table table-sm table-bordered table-hover">
                                <thead class="text-xs bg-sky">
                                    <tr>
                                        <th>Ref No.</th>
                                        <th>Date</th>
                                        <th class="col-1">From Bank</th>
                                        <th class="col-1">From Name</th>
                                        <th class="col-1">From Location</th>
                                        <th class="col-1">To Bank</th>
