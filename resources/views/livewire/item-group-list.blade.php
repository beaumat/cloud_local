<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('maintenanceinventoryitem_group') }}"> Item Group </a>
                    </h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <thead class="text-sm bg-sky">
                                    <tr>
                                        ...
                                        <th class="text-center col-1">
                                            <a href="{{ route('maintenanceinventoryitem_group_create') }}"
                                                class="text-white btn-sm"> <i class="fas fa-plus"></i></a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="text-sm">
                                    @foreach ($itemGroup as $list)
                                        <tr>
                                            <td> {{ $list->CODE }}</td>
                                            <td> {{ $list->DESCRIPTION }}</td>
                                            <td> {{ $list->ITEM_TYPE }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('maintenanceinventoryitem_group_edit', ['id' => $list->ID]) }}"
