    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 mt-1 text-sm" id="details" @if ($PRE_SIGN_DATA) style="opacity: 0.0" @endif>
                    ...
                    <div class="row bottom-line right-line left-line font-weight-bold">
                    ...
                    <div class="row bottom-line right-line left-line">
                        ...
                        <div id="p-pocket" class="col-1 text-right left-line font-weight-bold text-xs">
