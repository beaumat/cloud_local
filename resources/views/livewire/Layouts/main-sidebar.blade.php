<aside class="main-sidebar  sidebar-light-success elevation-1 text-xs">
    <a href="{{ route('dashboard') }}" class="brand-link">
        {{-- <img src="{{ asset('dist/img/AdminLTELogo.png') }}" alt="" class="brand-image elevation-0"
            style="opacity: .8"> --}}
            <b class="text-success">WRN</b>
        <span class="brand-text font-weight-light text-xs text-info"><b>Web</b> System</span>
    </a>
    <div class="sidebar">
        <nav class="mt-1">
