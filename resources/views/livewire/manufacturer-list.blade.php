<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h5 class="m-0"><a href="{{ route('maintenanceinventorymanufacturers_create') }}"> Manufacturer </a></h5>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <thead class="text-sm bg-sky">
                                    <tr>
                                        ...
                                        <th class="text-center col-1">
                                            <a href="{{ route('maintenanceinventorymanufacturers_create') }}"
                                    ...
                                    @foreach ($manufacturer as $list)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('maintenanceinventorymanufacturers_edit', ['id' => $list->ID]) }}"
