<div>
    ...
    <table class="table table-sm table-bordered table-hover">
        <thead class="text-xs bg-sky">
            <tr>
                ...
                <th class="col-5">Payment Methods</th>
        ...
        <tbody class="text-xs">
            @foreach ($data as $list)
                <tr>
                    <td>
                        <a target="_blank"
                            href="{{ route('transactionspayment_edit', ['id' => $list->PAYMENT_ID]) }}">{{ $list->CODE }}</a>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                        ...
                        <a href="#" title="Delete" id="deletebtn"
                            wire:click='delete({{ $list->ID }}, {{ $list->PAYMENT_ID }})'
    ...
    @livewire('ServiceCharge.PaymentModal', ['CUSTOMER_ID' => $CUSTOMER_ID, 'LOCATION_ID' => $LOCATION_ID, 'INVOICE_ID' => $INVOICE_ID])
</div>
