...
class WithholdingTaxServices
{
    ...
    public function __construct(ObjectServices $objectServices, SystemSettingServices $systemSettingServices, DateServices $dateServices, BillingServices $billingServices)
    {
