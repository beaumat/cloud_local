...
class CreditMemoServices
{
    ...
    public function __construct(ObjectServices $objectService, ComputeServices $computeServices, LocationReferenceServices $locationReferenceServices, SystemSettingServices $systemSettingServices, DateServices $dateServices)
    {
