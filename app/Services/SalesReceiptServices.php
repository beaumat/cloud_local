...
class SalesReceiptServices
{
    ...
    public function __construct(ObjectServices $objectServices, SystemSettingServices $systemSettingServices, DateServices $dateServices, ComputeServices $computeServices)
    {
