...
class ChargesRecord extends Component
{
    ...
    public function boot(ServiceChargeServices $serviceChargeServices, DateServices $dateServices, ContactServices $contactServices, LocationServices $locationServices)
    {
