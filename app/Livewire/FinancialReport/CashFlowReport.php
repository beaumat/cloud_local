...
class CashFlowReport extends Component
{
    ...
    public function generate()
    {
        ...
        if ($data) {
            ...
            $this->AddLine('+- in Trade & Other Receivables', 'text-info', $this->AcctFormat($TRADE_N_OTHER_RECEIVABLE));
            $this->AddLine('+- in Other Current Assets', 'text-info', $this->AcctFormat($OTHER_CURRENT_ASSET));
            $this->AddLine('+- in Other Non-Current Assets', 'text-info', $this->AcctFormat($OTHER_NON_CURRENT_ASSET));
            $this->AddLine('+- in Trade and Other Payables', 'text-info', $this->AcctFormat($TRADE_N_OTHER_PAYABLE));
